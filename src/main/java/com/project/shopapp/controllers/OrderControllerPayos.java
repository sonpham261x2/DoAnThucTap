...
import com.project.shopapp.configurations.ConfirmWebhookRequestBody;
...
import com.project.shopapp.configurations.CreatePaymentLinkRequestBody;
...
public class OrderControllerPayos {
    private final PayOS payOS;

    public OrderControllerPayos(PayOS payOS) {
        super();
        this.payOS = payOS;
    }
